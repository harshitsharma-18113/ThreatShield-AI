...
| Pipeline Phase | System Component & Action Flow | Target Operations |
| :--- | :--- | :--- |
| **Data Ingestion** | Network Infrastructure Logs Stream | Ingests rich JSON network traffic metadata schemas |
| **Reasoning Engine** | Gemini 1.5 Pro AI core orchestration loop | Processes multi-turn long-context logs for lateral threats |
| **Action Execution** | Model Context Protocol (MCP) Server | Fires `trigger_firewall_block` to instantly block attackers |
| **Human Escalation** | Tier 3 Strategic Incident Routing | Calls `escalate_to_human` for complex zero-day alerts |
| **Boundary Defense**| Day 4 Active Safety Guardrail Engine | Catches prompt injections at edge and triggers Red Audit Log |
